...
import { customTheme, SelectFieldProps, SelectOption } from "./common";
...
const CreatableMultiSelectField = <T extends FieldValues>({
    register,
    control,
    errors,
    name,
    ...
    const updateOptions = (selectedOptions: readonly SelectOption[]) => {
        setOptions(
            initialOptions
